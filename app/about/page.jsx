...
const about_us = () => {
  return (
    <main className=''>
      ...
      <section className='flex gap-4 my-[2.5rem] md:px-[7.61rem]'>
        <article className='flex flex-col items-center md:items-start w-[100%] md:w-auto'>
          ...
          <p className='text-center text-[1rem] tracking-[0.04rem] mb-[2.5rem] w-[18.096rem] md:w-[34.32rem] md:text-[1rem] md:text-left text-[#252128CC]'>
            Incepted in 2023, our aim is to provide valuable resources, training, and a warm community to accomodate diversity, 
            champion equality, and work tirelessly to create a more inclusive world where every person's unique abilities are 
            recognized and celebrated.
          </p>
          <a className=' shadow-card bg-primary w-[7.6875rem] md:w-[9.6875rem] h-[2.25rem] md:h-[3.5rem] flex items-center justify-center text-white font-[700] rounded-[0.5rem]'>
            Contact Us
          </a>
        </article>
      ...
      <section  className='flex flex-col lg:flex-row items-center md:px-[7.6rem] md:gap-[6.44rem] pb-[2.5rem] md:mt-[5.17rem]'>
        ...
        <article className='flex flex-col items-center md:items-start w-[100%] md:w-auto'>
          ...
          <p className='text-center text-[1rem] tracking-[0.04rem] mb-[2.5rem] w-[19.125rem] md:w-[34.32rem] md:text-[1rem] md:text-left text-[#252128CC]'>
            At Adaptive Tech Hub, innovation is at the heart of everything we do. our cutting-edge solutions not only provide tech skills and empowerment but also champions inclusive community. 
            We solve today's challenges but anticipate tomorrow's needs. Join a community of forward-thinkers for unparalleled security, seamless integration, and a tech future that's one step ahead.
          </p>
      ...
      <section className='flex flex-col lg:flex-row mx-5 md:mx-20 lg:mx-0 gap-[1.25rem] md:justify-center'>
        <div className='py-[2.07rem] px-[1.4rem] bg-[#FFF6FF] flex flex-col gap-[.75rem] rounded-[.75rem]'>
          ...
          <p className='w-[19.46rem] md:w-[31rem] text-[1rem] tracking-[0.04rem] text-heading'>
            To create an inclusive and empowering community for individuals living with disabiiitiess fostering personal growths, skill deveopments and meaningfull  
            connections in both technoogy and various other fields.
          </p>
        </div>
        <div className='py-[2.07rem] px-[1.4rem] bg-[#FFF6FF] flex flex-col gap-[.75rem] rounded-[.75rem]'>
          <h1 className='text-[1.25rem] font-[600] tracking-[0.05rem]'>
          ...
          <p className='w-[19.46rem] md:w-[31rem] text-[1rem] tracking-[0.04rem] text-heading'>
            To be the driving force behind a diverse, inclusive, and accessiible community that nurtures talents, embraces diversities and equips individuals with 
            disaiilities with the skills and resources needed to lead fulfillng lives and achieve their aspirations.
          </p>
        </div>
      </section>
      {/* Gallery */}
      ...
      {/* contact us */}
      <section className='justify-center px-4 my-[2.5rem] '>
