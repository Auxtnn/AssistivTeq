...
const Card = ({ title, text, logo }) => {
  return (
    <motion.div
      ...
      className="w-[18.3rem] h-[19.3] md:w-[22rem] md:h-[24.125rem] py-[1.47rem] md:py-[1.44rem] px-[.63rem] md:px-[1.34rem] border rounded-[1.875rem] shadow-card items-center md:items-start flex flex-col"
    >
