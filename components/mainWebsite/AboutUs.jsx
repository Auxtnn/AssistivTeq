...
const AboutUs = () => {
  const productCard = ({ icon, heading, text, mt }) => {
    return (
      <div
        className={`w-[10.09rem] md:w-auto flex flex-col gap-4 lg:gap-[1.88rem] mt-${mt} md:mt-0 lg:mt-${mt} shadow-pCard bg-white rounded-2xl hover:border-b-2- hover:border-primary px-4 py-[1.91rem] `}
      >
    ...
    <section id="about">
      ...
      <section className="flex justify-center  md:justify-evenly mt-[2.5rem] md:mt-[5rem] md:px-[4rem] md:gap-12 lg:gap-0 lg:px-0">
        ...
        >
          ...
          <a
            href="#contact"
            className="text-white hover:bg-white hover:text-primary hover:border-2 bg-primary w-full lg:w-[9.68rem] lg:h-[3.5rem] h-[2.25rem]  rounded-[1rem] flex items-center justify-center md:mt-0 font-[700]"
          >
            Contact Us
          </a>
        </motion.div>
      ...
      <section className="flex flex-col lg:flex-row mt-[2.5rem] lg:mt-20 lg:justify-evenly">
        <motion.div
          ...
          whileInView={[{ x: [-40, 0] }, { opacity: 1 }]}
          transition={{ duration: 1.5, ease: "easeInOut" }}
          className="px-4 lg:w-6/12 lg:ml-[5rem]"
        >
          <div className="">
            <Image
              alt="icon"
          ...
          <motion.h1
            ...
            transition={{ duration: 1.5, ease: "easeInOut" }}
            className="text-heading text-lg md:text-[2rem] tracking-wider font-bold mb-[.75rem] "
          >
            What we can do for you
          </motion.h1>
          <motion.h3
            ...
            transition={{ duration: 1.5, ease: "easeInOut" }}
            className="text-heading text-[1rem] md:text-2xl tracking-wider font-medium capitalize md:w-9/12 lg:w-[32.04rem] mb-[1.75rem] md:mb-4"
          >
        ...
        <motion.div
          ...
          whileInView={[{ y: [-40, 0] }, { opacity: 1 }]}
          transition={{ duration: 1.5, ease: "easeInOut" }}
          className="lg:w-6/12 flex flex-wrap lg:gap-[1.62rem] justify-evenly"
        >
          {productCard({
            icon: (
          ...
          {productCard({
            icon: (
              <TbBuildingCommunity className="text-primary w-[3.06rem] h-[3.06rem]" />
            ),
            heading: "Community",
          ...
          {productCard({
            mt: "[1.25rem]",
            icon: (
              <TbDisabled2 className="text-primary w-[3.06rem] h-[3.06rem]" />
            ),
            heading: "Empowerment",
          ...
          {productCard({
            mt: "[1.25rem]",
            icon: (
              <MdOutlineJoinInner className="text-primary w-[3.06rem] h-[3.06rem]" />
            ),
            heading: "Partnership",
